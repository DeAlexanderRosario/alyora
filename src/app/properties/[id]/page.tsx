...
import { getPublicPropertyById, getPublicProperties } from '@/lib/serverData';
...
export async function generateMetadata({ params }: PropertyPageProps): Promise<Metadata> {
  ...
  const property = await getPublicPropertyById(resolvedParams.id);
  ...
  return {
    ...
    alternates: {
      canonical: `https://homes.alyora.in/properties/${resolvedParams.id}`,
    },
    openGraph: {
      title: metaTitle,
      description: metaDescription,
      url: `https://homes.alyora.in/properties/${resolvedParams.id}`,
